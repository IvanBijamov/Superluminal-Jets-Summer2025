...
with model:
    ...
    # This seems to treat wt_true as a single parameter.  Really what I want is 
    # a distribution for each data point
    wt_true = pm.CustomDist("wt_true", wc, logp=loglike)
